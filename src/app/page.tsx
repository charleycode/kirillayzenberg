    ...
    <div>
      ...
      <section className="bg-[url('/Kirill-Ayzenberg-Hero-background-kirill-ayzenberg-llc.jpg')] bg-cover bg-center text-white">
        <div className="w-full px-4 mx-auto max-w-screen-xl py-16">
          <div className="flex flex-col md:flex-row items-center gap-8 border-y-2">
              <div className="w-1/2">
              <h1 className="lg:text-6xl px-6">Kirill Ayzenberg Mortgage Lender - Kirill Ayzenberg LLC 2</h1>
              <p className="text-xl px-6 mt-4">
                ...
                Understand Kirills expertise, evaluate his lending approach, and explore available services
              </p>
            </div>
            <div className="w-full md:w-1/2 px-6 mt-8 md:mt-0">
              <img
                src="/Kirill-Ayzenberg-Photo-Kirill-Ayzenberg-Website--Kirill-Ayzenberg-Hero-Image-Kirill-Ayzenberg-LLC.png"
                alt="Kirill Ayzenberg Hero"
                width={1200}
                height={400}
      ...
      <section className="text-black py-16 px-4 ">
        <div className="w-full mx-auto max-w-screen-xl flex flex-col gap-8">
          ...
          <Link href="/about-kirill-kirk-ayzenberg"><h2>Why Clients Trust Kirill Ayzenberg ( Kirk Ayzenberg )</h2></Link>
